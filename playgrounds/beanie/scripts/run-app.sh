#!/usr/bin/env bash
# Run the Beanie demo API locally against a local DocumentDB container.
#
# Starts DocumentDB in Docker (if not already running), sets up the app's
# Python virtualenv/dependencies, then runs the FastAPI + Beanie server.
#
...
echo ""
echo "=== Beanie demo app running locally ==="
